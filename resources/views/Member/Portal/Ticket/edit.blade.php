        ...
        <div class="container">
            <div class="header-layout">
                <div class="header-content">
                    <h1 class="premium-title">{{ __('messages.title_edit') }}</h1>
                    <p class="premium-subtitle">
                        {{ __('messages.description_edit') }}
                    </p>
                </div>
    ...
    <div class="premium-form-section">
        <div class="form-container-luxury">
            <div class="premium-form-card luxury-fade-up">
                <h2 class="form-title-luxury">{{ __('messages.form_title') }}</h2>
                <p class="form-subtitle-luxury">Update your support ticket information</p>
                
                <!-- Ticket Info Luxury -->
                <div class="ticket-info-luxury">
                    <div class="ticket-info-title-luxury">
                        <div class="ticket-info-icon-luxury">
                            <i class='bx bx-info-circle'></i>
                        </div>
                        <span>Ticket Information</span>
                    </div>
                    <div class="ticket-meta-luxury">
                        <div class="meta-item-luxury">
                            <div class="meta-icon-luxury">
                                <i class='bx bx-hash'></i>
                            </div>
                            <div>
                                <strong>ID:</strong> #{{ $ticket->id_after_sales }}
                            </div>
                        </div>
                        <div class="meta-item-luxury">
                            <div class="meta-icon-luxury">
                            ...
                            <div>
                                <strong>Created:</strong> {{ \Carbon\Carbon::parse($ticket->tgl_pengajuan)->format('M d, Y') }}
                            </div>
                        </div>
                        <div class="meta-item-luxury">
                            <div class="meta-icon-luxury">
                ...
                <form action="{{ route('tickets.update', $ticket->id_after_sales) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group-luxury">
                        ...
                        <select name="jenis_layanan" id="jenis_layanan" class="form-control-luxury" required>
                            <option value="Permintaan Data" {{ $ticket->jenis_layanan == 'Permintaan Data' ? 'selected' : '' }}>{{ __('messages.service_type') }} 1 - Data Request</option>
                            <option value="Maintanance" {{ $ticket->jenis_layanan == 'Maintanance' ? 'selected' : '' }}>{{ __('messages.service_type') }} 2 - Maintenance</option>
                            <option value="Visit" {{ $ticket->jenis_layanan == 'Visit' ? 'selected' : '' }}>{{ __('messages.service_type') }} 3 - Site Visit</option>
                            <option value="Installasi" {{ $ticket->jenis_layanan == 'Installasi' ? 'selected' : '' }}>{{ __('messages.service_type') }} 4 - Installation</option>
                        </select>
                        <div class="help-text-luxury">
                            <i class='bx bx-info-circle'></i>
                            <span>Change the type of service if needed</span>
                        </div>
                    </div>
                    ...
                    <div class="form-group-luxury">
                        ...
                        <textarea name="keterangan_layanan" 
                                  ...
                                  required>{{ $ticket->keterangan_layanan }}</textarea>
                        <div class="help-text-luxury">
                            <i class='bx bx-info-circle'></i>
                            <span>Update your description to provide more clarity</span>
                        </div>
                    </div>
                    ...
                    <div class="form-group-luxury">
                        ...
                        @if($ticket->file_pendukung_layanan)
                            <div class="current-file-luxury">
                                <div class="current-file-icon-luxury">
                                    <i class='bx bx-file'></i>
                                </div>
                                <div>
                                    <strong>Current file:</strong> 
                                    <a href="{{ asset($ticket->file_pendukung_layanan) }}" target="_blank" class="file-link-luxury">View current document</a>
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="file-input-wrapper-luxury">
                            ...
                            <label for="file_pendukung_layanan" class="file-input-label-luxury">
                                ...
                                <span>Click to upload new file or drag and drop</span>
                                <small>Maximum file size: 10MB</small>
                            </label>
                        </div>
                        <div class="help-text-luxury">
                            <i class='bx bx-info-circle'></i>
                            <span>Upload a new file to replace the current one (optional)</span>
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    fileInput.addEventListener('change', function() {
        if (this.files && this.files[0]) {
            ...
            fileLabel.textContent = 'Click to upload new file or drag and drop';
    ...
    form.addEventListener('submit', function(e) {
        ...
        submitBtn.innerHTML = '<i class="bx bx-loader-alt bx-spin"></i> <span>Updating...</span>';
        submitBtn.disabled = true;
    });

    // Auto-resize textarea with animation and set initial height
    ...
    // Enhanced meta item interactions
    document.querySelectorAll('.meta-item-luxury').forEach(item => {
