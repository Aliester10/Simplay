...
<style>
    ...
    * {
    ...
    .badge-guide { background: var(--gradient-secondary); }
    .badge-interactive { background: var(--gradient-violet); }
    .badge-updated { background: var(--gradient-success); }
    ...
    .premium-instruction-card:nth-child(2)::before { background: var(--gradient-violet); }
    .premium-instruction-card:nth-child(3)::before { background: var(--gradient-success); }
    .premium-instruction-card:nth-child(4)::before { background: var(--gradient-accent); }
    .premium-instruction-card:nth-child(5)::before { background: var(--gradient-rose); }
    .premium-instruction-card:nth-child(6)::before { background: var(--gradient-primary); }
    ...
    .premium-instruction-card:nth-child(2) .btn-primary-luxury { background: var(--gradient-violet); }
    .premium-instruction-card:nth-child(3) .btn-primary-luxury { background: var(--gradient-success); }
    .premium-instruction-card:nth-child(4) .btn-primary-luxury { background: var(--gradient-accent); }
    .premium-instruction-card:nth-child(5) .btn-primary-luxury { background: var(--gradient-rose); }
    .premium-instruction-card:nth-child(6) .btn-primary-luxury { background: var(--gradient-primary); }
    ...
    .premium-instruction-card:nth-child(2) .btn-secondary-luxury:hover { background: var(--gradient-violet); }
    .premium-instruction-card:nth-child(3) .btn-secondary-luxury:hover { background: var(--gradient-success); }
    .premium-instruction-card:nth-child(4) .btn-secondary-luxury:hover { background: var(--gradient-accent); }
    .premium-instruction-card:nth-child(5) .btn-secondary-luxury:hover { background: var(--gradient-rose); }
    .premium-instruction-card:nth-child(6) .btn-secondary-luxury:hover { background: var(--gradient-primary); }
        ...
        <div class="container">
            <div class="header-layout">
                <div class="header-content">
                    <h1 class="premium-title">{{ __('messages.user_manual') }}</h1>
                    <p class="premium-subtitle">
                        Panduan lengkap dan komprehensif untuk memaksimalkan penggunaan platform digital dengan tutorial step-by-step yang mudah dipahami dan fitur interaktif yang user-friendly.
                    </p>
                    
                    <div class="header-badges">
                        <div class="premium-badge badge-guide">
                        ...
                        <div class="premium-badge badge-updated">
            ...
            <div class="dashboard-grid">
                ...
                <div class="luxury-stat-card">
                    ...
                    <div class="stat-content">
                        ...
                        <div class="stat-number">{{ isset($uniqueProduks) ? str_pad($uniqueProduks->where('user_manual', '!=', null)->count(), 2, '0', STR_PAD_LEFT) : '00' }}</div>
                        <div class="stat-trend">
        ...
        <div class="container">
                    ...
                    @foreach($uniqueProduks as $produk)
                        <div class="premium-instruction-card luxury-fade-up">
                            ...
                            <div class="instruction-content-luxury">
                                ...
                                <div class="instruction-meta-luxury">
                                    <div class="meta-grid">
                                        ...
                                        <div class="meta-details">
                                            <h4>Document Type</h4>
                                            <span>{{ $produk->user_manual ? 'PDF Manual' : 'Not Available' }}</span>
                                        </div>
                                    </div>
                                </div>
                                
                                @if($produk->user_manual)
                                    <div class="instruction-buttons-luxury">
                                        <a href="{{ asset($produk->user_manual) }}" 
                                           download="{{ $produk->nama }}_manual.pdf" 
                                ...
                                @else
                                    <div class="instruction-buttons-luxury no-manual-state">
                                        <button class="btn-luxury btn-disabled-luxury" disabled>
                                            <i class='bx bx-info-circle'></i>
                                            <span>Manual Not Available</span>
                                        </button>
                                    </div>
                                @endif
                            </div>
            ...
            @else
                <div class="premium-empty-state">
                    ...
                    <h2 class="empty-title-luxury">No Manuals Available</h2>
                    <p class="empty-subtitle-luxury">
                        User manuals will appear here once products are available in your account. Please contact support if you need assistance.
                    </p>
